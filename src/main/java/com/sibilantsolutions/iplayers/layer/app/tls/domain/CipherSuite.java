...
public enum CipherSuite
{
    ...
    {
        final static private int TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 = 0xc02b;
        final static private int TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 = 0xc02f;
        final static private int TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA = 0xc00a;
        final static private int TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA = 0xc009;
        final static private int TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA = 0xc013;
        final static private int TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA = 0xc014;
        final static private int TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA = 0xc012;
        final static private int TLS_ECDHE_ECDSA_WITH_RC4_128_SHA = 0xc007;
        final static private int TLS_ECDHE_RSA_WITH_RC4_128_SHA = 0xc011;
        final static private int TLS_DHE_RSA_WITH_AES_128_CBC_SHA = 0x0033;
        final static private int TLS_DHE_DSS_WITH_AES_128_CBC_SHA = 0x0032;
        final static private int TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA = 0x0045;
        final static private int TLS_DHE_RSA_WITH_AES_256_CBC_SHA = 0x0039;
        final static private int TLS_DHE_DSS_WITH_AES_256_CBC_SHA = 0x0038;
        final static private int TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA = 0x0088;
        final static private int TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA = 0x0016;
        final static private int TLS_RSA_WITH_AES_128_CBC_SHA = 0x002f;
        final static private int TLS_RSA_WITH_CAMELLIA_128_CBC_SHA = 0x0041;
        final static private int TLS_RSA_WITH_AES_256_CBC_SHA = 0x0035;
        final static private int TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = 0x0084;
        final static private int TLS_RSA_WITH_3DES_EDE_CBC_SHA = 0x000a;
        final static private int TLS_RSA_WITH_RC4_128_SHA = 0x0005;
        final static private int TLS_RSA_WITH_RC4_128_MD5 = 0x0004;
    }
